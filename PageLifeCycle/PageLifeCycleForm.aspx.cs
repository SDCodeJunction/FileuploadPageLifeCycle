...
{
    public partial class PageLifeCycleForm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Work and It will assign the values to label.  
                lblName.Text = lblName.Text + "<br/>" + "Load - Postback - First request";
            }
            else if (IsPostBack)
            {
                lblName.Text = lblName.Text + "<br/>" + "Load - Postback - Susbsequent request";
            }
        }
